...
then
    ...
    body="{\"location\": \"${TF_VAR_location}\",\"properties\": {\"autoPause\": {\"enabled\": true,\"delayInMinutes\": 15},\"nodeSizeFamily\": \"MemoryOptimized\",\"nodeSize\": \"Large\",\"sparkVersion\": \"3.4\",\"autoScale\": {\"enabled\": false},\"nodeCount\": ${SYNAPSE_SPARK_NODE_COUNT},\"customLibraries\": [${customLibraries}],\"libraryRequirements\": {},\"sparkConfigProperties\": {\"configurationType\": \"File\",\"content\": \"${sparkConfiguration}\",\"filename\": \"config.txt\"}}}"
...
then
    ...
    body="{\"location\": \"${TF_VAR_location}\",\"properties\": {\"autoPause\": {\"enabled\": true,\"delayInMinutes\": 15},\"nodeSizeFamily\": \"MemoryOptimized\",\"nodeSize\": \"Large\",\"sparkVersion\": \"3.4\",\"autoScale\": {\"enabled\": false},\"nodeCount\": ${SYNAPSE_SPARK_NODE_COUNT},\"customLibraries\": [${customLibraries}],\"libraryRequirements\": {\"content\": \"${libraryRequirements}\",\"filename\": \"environment.yml\"},\"sparkConfigProperties\": {\"configurationType\": \"File\",\"content\": \"${sparkConfiguration}\",\"filename\": \"config.txt\"}}}"
    #echo "az rest --method PUT --url https://management.azure.com/subscriptions/${SUBSCRIPTION_ID}/resourceGroups/${RESOURCE_GROUP}/providers/Microsoft.Synapse/workspaces/${SYNAPSE_WORKSPACE_NAME}/bigDataPools/${SPARK_POOL_NAME}?api-version=2021-06-01 --headers \"${headers}\" --body \"${body}\""
    status=$(az rest --method PUT --url https://management.azure.com/subscriptions/${SUBSCRIPTION_ID}/resourceGroups/${RESOURCE_GROUP}/providers/Microsoft.Synapse/workspaces/${SYNAPSE_WORKSPACE_NAME}/bigDataPools/${SPARK_POOL_NAME}?api-version=2021-06-01 --headers "${headers}" --body "${body}")
    waitForDeployment
else
    echo "Recreating spark pool with library requirements"
    body="{\"location\": \"${TF_VAR_location}\",\"properties\": {\"autoPause\": {\"enabled\": true,\"delayInMinutes\": 15},\"nodeSizeFamily\": \"MemoryOptimized\",\"nodeSize\": \"Large\",\"sparkVersion\": \"3.4\",\"autoScale\": {\"enabled\": false},\"nodeCount\": ${SYNAPSE_SPARK_NODE_COUNT},\"customLibraries\": [],\"libraryRequirements\": {\"content\": \"${libraryRequirements}\",\"filename\": \"environment.yml\"},\"sparkConfigProperties\": {\"configurationType\": \"File\",\"content\": \"${sparkConfiguration}\",\"filename\": \"config.txt\"}}}"
